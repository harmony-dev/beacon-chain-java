...
public class SSZBuilder {
  ...
  public SSZBuilder withAccessorResolverRegistry(AccessorResolverRegistry accessorResolverRegistry) {
    checkAlreadyInitialized();
   ...
   *
   * <p>Uses {@link CompositeObjCreator} which tries to create model instance by one constructor with
  ...
  private SSZUnionAccessor createDefaultUnionAccessor() {
    return new UnionAccessor(sszSchemeBuilder);
  }
  ...
  void buildCommon() {
    if (sszSchemeBuilder == null) {
      SSZAnnotationSchemeBuilder sszAnnotationSchemeBuilder = new SSZAnnotationSchemeBuilder(
          schemeBuilderExplicitAnnotations);
