 ...
 * @see BeaconBlockBody
 * @see <a
 *     href="https://github.com/ethereum/eth2.0-specs/blob/v0.9.2/specs/core/0_beacon-chain.md#beaconblock">BeaconBlock
 *     in the spec</a>
 */
@SSZSerializable
public class BeaconBlock implements Hashable<Hash32> {
  ...
  public BeaconBlock withStateRoot(Hash32 stateRoot) {
    return new BeaconBlock(slot, parentRoot, stateRoot, body);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(slot, parentRoot, stateRoot, body);
  }
  ...
  public String toStringFull(@Nullable SpecConstants constants, @Nullable Time beaconStart,
    ...
    for (SignedVoluntaryExit voluntaryExit : body.getVoluntaryExits()) {
