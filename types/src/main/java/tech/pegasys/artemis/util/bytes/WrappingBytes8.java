...
/**
 * A simple class to wrap another {@link BytesValue} of exactly 8 bytes as a {@link Bytes8}.
 */
class WrappingBytes8 extends AbstractBytesValue implements Bytes8 {

  private final BytesValue value;

  WrappingBytes8(BytesValue value) {
  ...
  public MutableBytes8 mutableCopy() {
    MutableBytes8 copy = MutableBytes8.create();
    value.copyTo(copy);
    return copy;
  }
