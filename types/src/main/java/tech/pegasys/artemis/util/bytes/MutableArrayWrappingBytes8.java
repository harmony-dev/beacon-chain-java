...
/**
 * An implementation of {@link MutableBytes8} backed by a byte array ({@code byte[]}).
 */
class MutableArrayWrappingBytes8 extends MutableArrayWrappingBytesValue implements MutableBytes8 {

  MutableArrayWrappingBytes8(byte[] bytes) {
    this(bytes, 0);
  }

  MutableArrayWrappingBytes8(byte[] bytes, int offset) {
