...
/**
 * A simple class to wrap another {@link BytesValue} of exactly 16 bytes as a {@link Bytes16}.
 */
class WrappingBytes16 extends AbstractBytesValue implements Bytes16 {

  private final BytesValue value;

  WrappingBytes16(BytesValue value) {
  ...
  public MutableBytes16 mutableCopy() {
    MutableBytes16 copy = MutableBytes16.create();
    value.copyTo(copy);
    return copy;
  }
