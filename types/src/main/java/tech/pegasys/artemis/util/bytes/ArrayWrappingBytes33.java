...
/**
 * An implementation of {@link Bytes33} backed by a byte array ({@code byte[]}).
 */
class ArrayWrappingBytes33 extends ArrayWrappingBytesValue implements Bytes33 {

  ArrayWrappingBytes33(byte[] bytes) {
    this(checkLength(bytes), 0);
  }

  ArrayWrappingBytes33(byte[] bytes, int offset) {
