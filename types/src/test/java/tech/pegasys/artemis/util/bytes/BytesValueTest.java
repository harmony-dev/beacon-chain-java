...
import static tech.pegasys.artemis.util.bytes.BytesValue.*;
...
public class BytesValueTest {
  ...
  private static void assertWrap(byte[] bytes) {
    BytesValue value = wrap(bytes);
  ...
  private static void assertWrapSlice(byte[] bytes, int offset, int length) {
    BytesValue value = wrap(bytes, offset, length);
  ...
  public void wrapSliceReflectsUpdates() {
    ...
    BytesValue wrapped = wrap(bytes, 2, 2);
    BytesValue copy = wrapped.copy();
  ...
  private static void assertConcatenatedWrap(byte[] first, byte[] second) {
    byte[] res = wrap(wrap(first), wrap(second)).extractArray();
  ...
  public void concatenatedWrapDoesntReflectsUpdates() {
    ...
    BytesValue res = wrap(wrap(first), wrap(second));
  ...
  private static void assertWrapBuffer(byte[] bytes) {
  ...
  private static void assertWrapBufferSlice(byte[] bytes, int offset, int length) {
    Buffer buffer = Buffer.buffer(bytes);
    BytesValue value = wrapBuffer(buffer, offset, length);
    assertEquals(length, value.size());
    assertArrayEquals(Arrays.copyOfRange(bytes, offset, offset + length), value.extractArray());
  }
  ...
  public void wrapBufferSliceReflectsUpdates() {
    Buffer buffer = Buffer.buffer(new byte[] {1, 2, 3, 4, 5});
    BytesValue value = wrapBuffer(buffer, 2, 2);
    BytesValue copy = value.copy();
  ...
  @Test
  public void gets() {
    BytesValue v = wrap(new byte[] {1, 2, 3, 4});
  ...
  @Test
  public void getInt() {
    BytesValue value = wrap(new byte[] {0, 0, 1, 0, -1, -1, -1, -1});
  ...
  @Test
  public void getLong() {
    BytesValue value1 = wrap(new byte[] {0, 0, 1, 0, -1, -1, -1, -1, 0, 0});
    ...
    BytesValue value2 = wrap(new byte[] {-1, -1, -1, -1, -1, -1, -1, -1});
  ...
  public void rangedMutableCopy() {
    BytesValue v = h("0x012345");
    MutableBytesValue mutableCopy = v.mutableCopy();
  ...
  public void copying() {
    ...
    BytesValue.of(1).copyTo(dest);
    assertEquals(h("0x01"), dest);

    dest = MutableBytesValue.create(1);
    BytesValue.of(10).copyTo(dest);
    assertEquals(h("0x0A"), dest);

    dest = MutableBytesValue.create(2);
    BytesValue.of(0xff, 0x03).copyTo(dest);
    assertEquals(h("0xFF03"), dest);

    dest = MutableBytesValue.create(4);
    BytesValue.of(0xff, 0x03).copyTo(dest.mutableSlice(1, 2));
  ...
  public void copyingToTooSmall() {
    ...
    BytesValue.of(1, 2, 3).copyTo(MutableBytesValue.create(2));
  }
  ...
  public void copyingToTooBig() {
    ...
    BytesValue.of(1, 2, 3).copyTo(MutableBytesValue.create(4));
  }
  ...
  public void copyingToWithOffset() {
    ...
    dest = MutableBytesValue.wrap(new byte[] {1, 2, 3});
    BytesValue.of(1).copyTo(dest, 1);
    assertEquals(h("0x010103"), dest);

    dest = MutableBytesValue.wrap(new byte[] {1, 2, 3});
    BytesValue.of(2).copyTo(dest, 0);
    assertEquals(h("0x020203"), dest);

    dest = MutableBytesValue.wrap(new byte[] {1, 2, 3});
    BytesValue.of(1, 1).copyTo(dest, 1);
    assertEquals(h("0x010101"), dest);

    dest = MutableBytesValue.create(4);
    BytesValue.of(0xff, 0x03).copyTo(dest, 1);
    assertEquals(h("0x00FF0300"), dest);
  }
  ...
  public void copyingToWithOffsetTooSmall() {
    ...
    BytesValue.of(1, 2, 3).copyTo(MutableBytesValue.create(4), 2);
  }

  @Test(expected = IndexOutOfBoundsException.class)
  public void copyingToWithNegativeOffset() {
    BytesValue.of(1, 2, 3).copyTo(MutableBytesValue.create(10), -1);
  }

  @Test(expected = IndexOutOfBoundsException.class)
  public void copyingToWithOutOfBoundIndex() {
    BytesValue.of(1, 2, 3).copyTo(MutableBytesValue.create(10), 10);
  }
  ...
  private void assertAppendTo(BytesValue toAppend, Buffer buffer, BytesValue expected) {
  ...
  private void assertAppendToByteBuf(BytesValue toAppend, ByteBuf buffer, BytesValue expected) {
    toAppend.appendTo(buffer);
    byte[] arr = new byte[buffer.writerIndex()];
    buffer.getBytes(0, arr);
  ...
  public void findsCommonPrefix() {
    BytesValue v = BytesValue.of(1, 2, 3, 4, 5, 6, 7);
    BytesValue o = BytesValue.of(1, 2, 3, 4, 4, 3, 2);
  ...
  public void findsCommonPrefixOfShorter() {
    BytesValue v = BytesValue.of(1, 2, 3, 4, 5, 6, 7);
    BytesValue o = BytesValue.of(1, 2, 3, 4);
    assertThat(v.commonPrefixLength(o)).isEqualTo(4);
    assertThat(v.commonPrefix(o)).isEqualTo(BytesValue.of(1, 2, 3, 4));
  }
  ...
  public void findsCommonPrefixOfLonger() {
    BytesValue v = BytesValue.of(1, 2, 3, 4);
    BytesValue o = BytesValue.of(1, 2, 3, 4, 4, 3, 2);
    assertThat(v.commonPrefixLength(o)).isEqualTo(4);
    assertThat(v.commonPrefix(o)).isEqualTo(BytesValue.of(1, 2, 3, 4));
  }
  ...
  public void findsCommonPrefixOfSliced() {
    BytesValue v = BytesValue.of(1, 2, 3, 4).slice(2, 2);
    BytesValue o = BytesValue.of(3, 4, 3, 3, 2).slice(3, 2);
  ...
  public void arrayExtraction() {
    ...
    BytesValue value = wrap(orig);
    byte[] extracted = value.extractArray();
    ...
    assertEquals(BytesValue.of(1, 2, 3, 4), value);
  }

  private void assertArrayExtraction(Function<BytesValue, byte[]> extractor) {
  ...
  public void asString() {
    ...
    assertEquals("0x01", BytesValue.of(1).toString());
    assertEquals("0x0aff03", BytesValue.of(0x0a, 0xff, 0x03).toString());
  }

  @Test
  public void testBytesValuesComparatorReturnsMatchUnsignedValueByteValue() {
    BytesValue big = BytesValue.of(129);
    BytesValue small = BytesValue.of(127);
    BytesValue otherSmall = BytesValue.of(127);
  ...
  public void testGetSetBit() {
    ...
    assertEquals((byte) 0b00000001, bytes.get(0));
    for (int i = 1; i < 32; i++) {
      assertEquals(false, bytes.getBit(i));
    }
    bytes.setBit(0, true);
    ...
    assertEquals((byte) 0b00000010, bytes.get(0));
    assertEquals(false, bytes.getBit(0));
    for (int i = 2; i < 32; i++) {
      assertEquals(false, bytes.getBit(i));
    }
    ...
    assertEquals((byte) 0b00100010, bytes.get(0));

    bytes.setBit(15, true);
    assertEquals(true, bytes.getBit(15));
    assertEquals((byte) 0b00100010, bytes.get(0));
    assertEquals((byte) 0b10000000, bytes.get(1));
