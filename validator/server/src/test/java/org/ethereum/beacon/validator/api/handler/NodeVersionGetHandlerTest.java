...
@Ignore
public class NodeVersionGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(NodeVersionGetHandlerTest.class);
    ...
    @Test
    public void testNodeVersionGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/node/version";
