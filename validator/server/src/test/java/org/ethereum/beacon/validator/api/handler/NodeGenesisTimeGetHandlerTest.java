...
@Ignore
public class NodeGenesisTimeGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(NodeGenesisTimeGetHandlerTest.class);
    ...
    @Test
    public void testNodeGenesisTimeGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/node/genesis_time";
