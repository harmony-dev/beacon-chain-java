...
public class BeaconChainAttesterTest {
  ...
  @Test
  public void attestASlotWithPrepareFunction() {
    Random random = new Random();
    ...
    Attestation unsignedAttestation =
        attester.prepareAttestation(
            validatorIndex, shard, initiallyObservedState, stateEx.getSlot());
    BLSSignature aggregateSignature =
        BeaconChainAttester.getAggregateSignature(
            stateEx, unsignedAttestation.getData(), signer, spec);
